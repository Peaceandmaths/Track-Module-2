...
# Run tensorboard in web 
# tensorboard --logdir /home/golubeka/Trackmodule2/runs --port 6009 
...
# Hyperparameter tuning : randomized or grid
...
for learning_rate in [0.1, 0.01, 0.001, 0.0001]:
    ...
    train_model(model, optimizer=optimizer,criterion= criterion, scheduler=plateau_scheduler)
    accuracy = eval_model(model, num_classes=2,data_loader = dataloaders['test'])
